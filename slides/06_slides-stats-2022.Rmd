...
summary( mlmfit2 <- lm(DUOX1_exp ~ DUOXA1_exp  + gender + smoking , data = tcga) )
...
##  Multivariable regression
 ...
 Residual standard error: 1086 on 580 degrees of freedom
  (458 observations deleted due to missingness)
  
Multiple R-squared:  0.7758,	Adjusted R-squared:  0.7743

F-statistic: 501.8 on 4 and 580 DF,  p-value: < 0.00000000000000022
---
