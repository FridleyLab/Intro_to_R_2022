...
# # MERGE and making smoking variable 
  ...
  clinical2 <- read_csv(file = "F:\\myGitRepo\\Intro_to_R_2022\\data\\tcga_clinical.txt" ) 
...
```{r comment=NA}
# clinical <- read.csv(file = "F:\\myGitRepo\\Intro_to_R_2022\\data\\tcga_clinical.txt",
#                      header = TRUE)
# geneexp <- read.csv(file = "F:\\myGitRepo\\Intro_to_R_2022\\data\\tcga_gene_exp.txt", 
#                     header = TRUE)
#  
...
# clinical <- read.csv(file = here("data","tcga-clinical.csv"),
#                      header = TRUE)
# geneexp <- read.csv(file = here("data","tcga-clinical.csv"), 
#                     header = TRUE)
...
##  Simple linear regression:  residual variance
